...
def main():
    ...
    inject_local_font(os.path.join(os.getcwd(), "static", "AdodeClean.otf"), "AdobeClean")
    ...
    if "voice_pipeline" not in st.session_state:
        try:
            ...
            st.error(f"Groq initialization failed:\n{e}")
    ...
    with st.sidebar:
        ...
        if st.session_state.username:
            st.caption(f"🧑‍🦱 Login as {(st.session_state.username).capitalize()}")
        ...
        if workout_started:
            ...
            if exercise == "Squats":
                ...
                st.metric("Body Angle", st.session_state.body_alignment)
